...
public class ActualizarPagoRealizado {
    ...
    @FXML
    void actionConsultarRealizado(ActionEvent event) throws IOException {
        navigateTo("/fxml/Pagos/ConsultarPagoRealizado.fxml", event);
    }
