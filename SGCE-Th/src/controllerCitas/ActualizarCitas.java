...
public class ActualizarCitas {
    ...
    void actionReagendarCitas(ActionEvent event) throws IOException {
        navigateTo("/fxml/Citas/ReagendarCita.fxml", (Stage) btnReagendarCita.getScene().getWindow());
    }
    @FXML
    void actionConcluirCitas(ActionEvent event) throws IOException {
        navigateTo("/fxml/Citas/ConcluirCita.fxml", (Stage) btnConcluirCita.getScene().getWindow());
    }
